 ...
 * @since 156
 */
public abstract class FormulaCommandVisitor {
    private final FormulaContext formulaContext;
    private final Deque<String> nestedFormulaNames;

    protected FormulaCommandVisitor(FormulaContext formulaContext) {
    ...
    public abstract void visit(FormulaCommand formulaCommand);
     ...
     */
    static class MergeFieldValidator extends FormulaCommandVisitor {
     ...
     */
    static class StaleSummaryField extends FormulaCommandVisitor {
     ...
     */
    static class DeterministicFormula extends FormulaCommandVisitor {
     ...
     */
    static class AIPredictionFieldReference extends FormulaCommandVisitor {
     ...
     * @return true if the formula is deterministic
     */
    static class CustomIndexableFormula extends FormulaCommandVisitor {
     ...
     * @return true if the formula is deterministic
     */
    static class FlexIndexableFormula extends FormulaCommandVisitor {
     ...
     */
    static class CustomIndexablePostSaveIndexUpdated extends FormulaCommandVisitor {
     ...
     * @since 182
     */
    public static class FieldReferenceCommandVisitor extends FormulaCommandVisitor {
