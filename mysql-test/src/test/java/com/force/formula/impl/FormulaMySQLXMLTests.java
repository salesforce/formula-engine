...
/**
 * A test suite that uses test xml file - formulaTestV2.xml to generate and run those tests using mysql database
 */
@RunWith(AllTests.class)
public class FormulaMySQLXMLTests extends FormulaXMLTestSuite {
    ...
    public FormulaMySQLXMLTests(List<String> testDefinitionAbsoluteFilePaths, IFormulaTestDefinitionParser fileParser, IFormulaTestCaseFilter testCaseFilter, String goldFileDirectory) {
        super("FormulaMySQLXMLTests", testDefinitionAbsoluteFilePaths, fileParser, testCaseFilter, goldFileDirectory);
    }

    /**
     * Creates a test suite by providing
     *      test xml file paths,
     *      setting database specific hooks for mysql,
     ...
     *      and a directory path for mysql specific gold files.
     *
    ...
    public static TestSuite suite() {
        ...
        //The following hook has mysql as the database hook
        ...
        String goldFileDirectory = "src/test/goldfiles/FormulaFields/v2/mysql";
        return new FormulaMySQLXMLTests(xmlFiles, parser, null, goldFileDirectory);
    }

    /**
     * Creates a mysql database tester
     * @return a mysql database tester
    ...
    protected static class MysqlFormulaValidationHooks extends BaseCustomizableParserTest.FieldTestFormulaValidationHooks {
        @Override
