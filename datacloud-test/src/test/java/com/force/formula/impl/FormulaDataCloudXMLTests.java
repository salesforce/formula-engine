...
public class FormulaDataCloudXMLTests extends FormulaXMLTestSuite {
    ...
    // Reuse a single DataCloud connection across all tests
    static DbTester SHARED_TESTER;
    static {
        try {
            SHARED_TESTER = new DataCloudTester();
     ...
     *      test xml file paths,
     *      setting database specific hooks for DataCloud (postgres-compatible SQL),
    ...
    public static TestSuite suite() {
        ...
        FormulaEngine.setHooks(new DataCloudFormulaValidationHooks());
    ...
    protected static class DataCloudFormulaValidationHooks extends BaseCustomizableParserTest.FieldTestFormulaValidationHooks {
        @Override
