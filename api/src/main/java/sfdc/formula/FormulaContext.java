...
public interface FormulaContext extends Tokenizer {
    public static final String DO_NOT_TREAT_NULLS_AS_STRING = "common.formula.DO_NOT_TREAT_NULLS_AS_STRING";
    public static final String ALLOW_NULL_MAP_KEY = "common.formula.ALLOW_NULL_MAP_KEY";
    public static final String FILTER_ENCRYPTED_FIELDS = "filterEncryptedFields";
    public static final String DO_NOT_USE_DB_VALUE_FOR_PICKLIST_EVALUATION = "common.formula.DO_NOT_USE_DB_VALUE_FOR_PICKLIST_EVALUATION";
    public static final String SKIP_PERCENT_VALUE_ADJUST = "common.formula.SKIP_PERCENT_VALUE_ADJUST";
    ...
    public static final String EXPAND_FORMULA_REFERENCES = "common.formula.EXPAND_FORMULA_REFERENCES";
    public static final String FORMULA_FILTER = "common.config.field.FORMULA_FILTER";
    public static final String CHECK_SQL_LENGTH_LIMIT = "sfdc.formula.impl.CHECK_SQL_LENGTH_LIMIT";
    public static final String HIGHPRECISION_JS = "sfdc.formula.impl.HIGHPRECISION_JS";
    /** See {@link #jsDatesAreStrings} */
    public static final String JS_DATES_ARE_STRINGS = "sfdc.formula.impl.JS_DATES_ARE_STRINGS";

    public static final String IS_CREATE_OR_EDIT_FORMULA = "sfdc.formula.impl.IS_CREATE_OR_EDIT_FORMULA";
