...
public class FormulaEngine {
    ...
    // Yes, we're using a static.  This should be overrideable in a test context in a less crappy way.
    ...
    private static final String FACTORYIMPLCLASSNAME = "sfdc.formula.impl.FormulaFactoryImpl";
    ...
    static {
        ...
        try {
            hooksClasses.add(Class.forName("sfdc.formula.impl.FormulaValidationHooks"));
