...
public class TestSpannerStandardFormulas extends FormulaSpannerTests {

	
    public TestSpannerStandardFormulas(String owner) throws FileNotFoundException, ParserConfigurationException, SAXException, IOException {
        super("SpannerStandardFormulaTests");
    }

    public static TestSuite suite()
    {
        try {
            return new TestSpannerStandardFormulas("no");
