...
/**
 * A test suite that uses test xml file - formulaTestV2.xml to generate and run those tests using Spanner database
 */
@RunWith(AllTests.class)
public class FormulaSpannerXMLTests extends FormulaXMLTestSuite {
    ...
    public FormulaSpannerXMLTests(List<String> testDefinitionAbsoluteFilePaths, IFormulaTestDefinitionParser fileParser, IFormulaTestCaseFilter testCaseFilter, String goldFileDirectory) {
        super("FormulaSpannerXMLTests", testDefinitionAbsoluteFilePaths, fileParser, testCaseFilter, goldFileDirectory);
    }

    /**
     * Creates a test suite by providing
     *      test xml file paths,
     *      setting database specific hooks for Spanner,
     ...
     *      and a directory path for Spanner specific gold files.
     *
    ...
    public static TestSuite suite() {
        ...
        //The following hook has Spanner as the database hook
        ...
        String goldFileDirectory = "src/test/goldfiles/FormulaFields/v2/Spanner";
        return new FormulaSpannerXMLTests(xmlFiles, parser, null, goldFileDirectory);
    }

    /**
     * Creates a Spanner database tester
     * @return a Spanner database tester
    ...
    protected static class SpannerFormulaValidationHooks extends BaseCustomizableParserTest.FieldTestFormulaValidationHooks {
        @Override
