...
public class TestSqliteStandardFormulas extends FormulaSqliteTests {

	
    public TestSqliteStandardFormulas(String owner) throws FileNotFoundException, ParserConfigurationException, SAXException, IOException {
        super("SqliteStandardFormulaTests");
    }

    public static TestSuite suite()
    {
        try {
            return new TestSqliteStandardFormulas("no");
