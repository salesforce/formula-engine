...
public class TestMsSqlServerStandardFormulas extends FormulaMsSqlServerTests {

	
    public TestMsSqlServerStandardFormulas(String owner) throws FileNotFoundException, ParserConfigurationException, SAXException, IOException {
        super("MSSQLStandardFormulaTests");
    }

    public static TestSuite suite()
    {
        try {
            return new TestMsSqlServerStandardFormulas("no");
